<div class="option-box" id="admin-options-<?php echo $ctrl_id; ?>">
  ...
  <div class="postbox">
    ...
    <div class="inside">
      <p><label>Phone版式 ≤ <input type="text" name="options[response_phone_width]" class="regular-text short-text" value="<?php echo $admin_options['response_phone_width']; ?>">px</label>，<label>Pad版式 ≤ <input type="text" name="options[response_pad_width]" class="regular-text short-text" value="<?php echo $admin_options['response_pad_width']; ?>">px</label>，<label>窄屏版式 ≤ <input type="text" name="options[response_screen_width]" class="regular-text short-text" value="<?php echo $admin_options['response_screen_width']; ?>">px</label>。<br><small>设置好之后用pad或手机浏览你的网站检查效果。推荐为800和480。窄屏是指在一些屏幕比较小的电脑上（平板横屏时）显示的不同的排版。留空时不使用自适应屏幕功能。</small></p>
    </div>
    <div class="inside">
