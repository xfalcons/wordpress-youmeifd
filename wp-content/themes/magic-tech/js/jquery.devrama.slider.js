...
(function($){
  var DrSlider = function(element, options){
    ...
    this.options = {
      ...
      navigationColor: '#7E7E7E',
      navigationHoverColor: '#EB7F60',
      navigationHighlightColor: '#EB7F60',
    ...
    _init: function(){
      ...
      this._stopTimer(function(){
        that._prepare(function(){
          ...
          that._playSlide();
          if(typeof that.options.onLoad == 'function') that.options.onLoad(); 
